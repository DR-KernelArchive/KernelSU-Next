...
setup_kernelsu() {
    ...
    test -d "$GKI_ROOT/KernelSU-Next" || git clone https://github.com/kernel-build-from-rainyland/KernelSU-Next-Custom && echo "[+] Repository cloned."
    mv ./KernelSU-Next-Custom ./KernelSU-Next
